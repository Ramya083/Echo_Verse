...
def apply_custom_styles():
    st.markdown("""
        <style>
            .stApp { background-color: white; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; }
            .stTextArea textarea { background-color: white !important; color: Black !important; border: 1px solid #3b82f6; }
            ...
            .st.sidebar { background-color: green}
            /* Sidebar background and text color */
            .stSidebar { background-color: #00809D; color: #f9fafb; }
            /* To make the sidebar headers and widgets more readable */
            .stSidebar .css-1d391kg { color: #f9fafb; }
            .stSidebar .css-1v0mbdj { color: #f9fafb; }
             .css-1v3fvcr h1, /* current default Streamlit class for h1 */
        h1 {
            color: Black !important;  /* tomato red, replace with any color */
        }
        .css-1kyxreq pre, /* For code blocks */
        .css-1v0mbdj, /* For markdown text blocks */
        .stMarkdown p {
        color: black !important;  /* your preferred color */
        }
...
def main():
    apply_custom_styles()
    st.title("🎧 EchoVerse- input-to-audio Styler & Narrator")
